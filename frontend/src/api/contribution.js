    ...
    data: [
      {
        ...
        description:
          "Quỹ xây dựng, tu sửa nhà thờ họ Nguyễn Hữu đợt 1 năm 2026.",
        excelUrl:
          "https://gia-pha-images.s3.us-east-1.amazonaws.com/contributions/xay-nha-tho-2026.xlsx",
      ...
      },
      {
        ...
        excelUrl:
          "https://gia-pha-images.s3.us-east-1.amazonaws.com/contributions/gio-to-2025.xlsx",
...
export const getContributionById = (id) => {
  return Promise.resolve({
    data: {
      ...
      description: "Danh sách con cháu đóng góp cho lễ giỗ tổ hằng năm.",
      excelUrl:
        "https://docs.google.com/spreadsheets/d/1BUMh3qar4ZL7ytmBnYdlktZaUv81REyZ/edit?usp=sharing&ouid=115544203726347606869&rtpof=true&sd=true",
      eventDate: "2025-08-20",
      createdAt: "2025-08-05T09:30:00",
    },
  });
