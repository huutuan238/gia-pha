...
const events = reactive([
  {
    ...
    day: "12",
    month: "Th.08",
    title: "Giỗ tổ họ Nguyễn — đời thứ nhất",
    description:
      "Tổ chức tại nhà thờ họ, làng Đông Bàn. Con cháu các chi tề tựu dâng hương.",
    notified: true,
    recipients: 128,
  },
  {
    ...
    day: "03",
    month: "Th.09",
    title: "Họp mặt con cháu chi thứ 3",
    description:
  ...
  },
  {
    ...
    day: "21",
    month: "Th.10",
    title: "Sinh nhật cụ Nguyễn Văn Khoa (đời 7)",
